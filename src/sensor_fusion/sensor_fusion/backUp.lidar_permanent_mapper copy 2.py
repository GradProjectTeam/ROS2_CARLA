...
class LidarPermanentMapper(Node):
    ...
    def save_map(self):
        ...
        with self.map_lock:
            ...
            # Apply thresholds for clear black and white visualization
            binary_map[self.permanent_map < 30] = 0       # Definitely free (white)
            binary_map[self.permanent_map > 70] = 100     # Definitely occupied (black)
            binary_map[(self.permanent_map >= 30) & (self.permanent_map <= 70)] = -1  # Unknown (gray)
