...
def generate_launch_description():
    ...
    forward_weight_arg = DeclareLaunchArgument('forward_weight', default_value='1.0')
    ...
    preferred_direction_arg = DeclareLaunchArgument('preferred_direction', default_value='0.0')
    clearance_threshold_arg = DeclareLaunchArgument('clearance_threshold', default_value='2.0')
    stop_threshold_arg = DeclareLaunchArgument('stop_threshold', default_value='0.5')
    ...
    return LaunchDescription([
        ...
        # Navigation parameters
        preferred_direction_arg,
        clearance_threshold_arg,
        stop_threshold_arg,
